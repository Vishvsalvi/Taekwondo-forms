          ...
          <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
            <div className="max-w-xl lg:max-w-3xl">
              ...
              <form encType='multipart/form-data' className="mt-8 grid grid-cols-6 gap-6">
                ...
                <div className="col-span-6 sm:col-span-3">
                  <label htmlFor="poomsaeType" className="block text-sm font-medium text-gray-700">
                    Poomsae Type
                  </label>
                ...
                {/* Make it a dropdown */}
                <div className="col-span-6 sm:col-span-3">
                  <label htmlFor="beltColor" className="block text-sm font-medium text-gray-700">
                    Belt Color
                  </label>
